...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			features.Table:                   features.ValidColumn,
			featuresunitvalues.Table:         featuresunitvalues.ValidColumn,
			featuresvalues.Table:             featuresvalues.ValidColumn,
			featuresvaluestypes.Table:        featuresvaluestypes.ValidColumn,
			imagefolderpath.Table:            imagefolderpath.ValidColumn,
			imagefoldersource.Table:          imagefoldersource.ValidColumn,
			images.Table:                     images.ValidColumn,
			infotypes.Table:                  infotypes.ValidColumn,
			pricetype.Table:                  pricetype.ValidColumn,
			producthasfeature.Table:          producthasfeature.ValidColumn,
			producthasimage.Table:            producthasimage.ValidColumn,
			producthasinfo.Table:             producthasinfo.ValidColumn,
			producthasproductreference.Table: producthasproductreference.ValidColumn,
			productinfo.Table:                productinfo.ValidColumn,
			productprices.Table:              productprices.ValidColumn,
			productreferences.Table:          productreferences.ValidColumn,
			products.Table:                   products.ValidColumn,
			promotionhasproduct.Table:        promotionhasproduct.ValidColumn,
			promotions.Table:                 promotions.ValidColumn,
			referencesources.Table:           referencesources.ValidColumn,
			toolhasproduct.Table:             toolhasproduct.ValidColumn,
			tools.Table:                      tools.ValidColumn,
			user.Table:                       user.ValidColumn,
			varianttype.Table:                varianttype.ValidColumn,
		})
	})
