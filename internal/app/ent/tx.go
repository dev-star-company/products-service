...
func (tx *Tx) init() {
	...
	tx.Features = NewFeaturesClient(tx.config)
	tx.FeaturesUnitValues = NewFeaturesUnitValuesClient(tx.config)
	tx.FeaturesValues = NewFeaturesValuesClient(tx.config)
	tx.FeaturesValuesTypes = NewFeaturesValuesTypesClient(tx.config)
	tx.ImageFolderPath = NewImageFolderPathClient(tx.config)
	tx.ImageFolderSource = NewImageFolderSourceClient(tx.config)
	tx.Images = NewImagesClient(tx.config)
	tx.InfoTypes = NewInfoTypesClient(tx.config)
	tx.PriceType = NewPriceTypeClient(tx.config)
	tx.ProductHasFeature = NewProductHasFeatureClient(tx.config)
	tx.ProductHasImage = NewProductHasImageClient(tx.config)
	tx.ProductHasInfo = NewProductHasInfoClient(tx.config)
	tx.ProductHasProductReference = NewProductHasProductReferenceClient(tx.config)
	tx.ProductInfo = NewProductInfoClient(tx.config)
	tx.ProductPrices = NewProductPricesClient(tx.config)
	tx.ProductReferences = NewProductReferencesClient(tx.config)
	tx.Products = NewProductsClient(tx.config)
	tx.PromotionHasProduct = NewPromotionHasProductClient(tx.config)
	tx.Promotions = NewPromotionsClient(tx.config)
	tx.ReferenceSources = NewReferenceSourcesClient(tx.config)
	tx.ToolHasProduct = NewToolHasProductClient(tx.config)
	tx.Tools = NewToolsClient(tx.config)
	tx.User = NewUserClient(tx.config)
	tx.VariantType = NewVariantTypeClient(tx.config)
}
